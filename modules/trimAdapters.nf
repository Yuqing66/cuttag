...
process trimAdapters {
    ...
    output:
    tuple val(sample_id), val(meta), val(chunk_id), path("cut/${sample_id}/${sample_id}_${chunk_id}_R1_cut.fastq.gz"), path("cut/${sample_id}/${sample_id}_${chunk_id}_R2_cut.fastq.gz")
